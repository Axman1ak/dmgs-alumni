            ...
            {user ? (
              <>
                ...
                <Link
                  href="/account"
                  title="My profile"
                  className="ml-2 flex items-center gap-2.5 rounded-full bg-emerald-900 py-1.5 pl-3.5 pr-1.5 font-sans text-[13px] text-cream no-underline transition-opacity hover:opacity-90"
                >
                  {initials || "—"}
